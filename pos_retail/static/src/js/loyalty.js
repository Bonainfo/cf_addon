...
odoo.define('pos_retail.loyalty', function (require) {
    ...
    models.Orderline = models.Orderline.extend({
        ...
        set_unit_price: function (price) {
            if (this.redeem_point && !this.order.syncing) {
                return this.pos.gui.show_popup('confirm', {
                    title: 'Warning',
                    body: 'This is reward line, could not change price',
                });
            }
            _super_Orderline.set_unit_price.apply(this, arguments);
        },
        set_quantity: function (quantity, keep_price) {
            if (this.redeem_point && quantity != 'remove' && quantity != '' && !this.order.syncing) {
                return this.pos.gui.show_popup('confirm', {
                    title: 'Warning',
                    body: 'This is reward line, could not change quantity',
                });
            }
        ...
        set_discount: function (discount) {
            if (this.redeem_point && !this.order.syncing) {
                return this.pos.gui.show_popup('confirm', {
                    title: 'Warning',
                    body: 'This is reward line, could not change discount',
                });
            }
