    ...
    models.load_models([
        {
            ...
            fields: ['name', 'start_date', 'end_date', 'type', 'product_id', 'discount_lowest_price', 'product_ids', 'minimum_items'],
        ...
        /*
            only horkans project implement this function
        {
