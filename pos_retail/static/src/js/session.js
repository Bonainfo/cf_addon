"use strict";
odoo.define('pos_retail.session', function (require) {
    ...
    var button_session = screens.ActionButtonWidget.extend({
        template: 'button_session',
    ...
    screens.define_action_button({
        'name': 'button_session',
        'widget': button_session,
        'condition': function () {
            return this.pos.config.management_session;
        }
    });
