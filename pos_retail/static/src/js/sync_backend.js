odoo.define('pos_retail.pos_chanel', function (require) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        syncing_category: function (category_data) {
            this.db.add_categories([category_data]);
            $('.breadcrumb-home').click();
            this.categories = _.filter(this.categories, function (categ) {
                return categ.id != category_data['id'];
            })
