...
class WebkulWebsiteAddons(models.TransientModel):
    ...
    module_website_single_page_checkout = fields.Boolean(string = "Website: Single Page Checkout")
    ...
    module_website_quote_system = fields.Boolean("Website: Quote System")
    module_website_collectional_page = fields.Boolean(string = "Website: Collection Page")
    module_website_gift_card = fields.Boolean(string="Webiste Gift Card")
