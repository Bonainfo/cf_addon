...
class AffiliateRequest(models.Model):
    ...
    def send_joining_mail(self,aff_request):
        ...
        _logger.info("-----------call send mail-------")
        _logger.info("-----aff_request.signup_valid--%r----call send mail-------",aff_request.signup_valid)


    def regenerate_token(self):
        _logger.info('-----=Regenetarte token---------%r--',self)
